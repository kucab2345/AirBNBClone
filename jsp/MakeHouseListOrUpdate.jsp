...
<script LANGUAGE="javascript">
	function CreateNew()
	{
		window.location.href = "/~5530u47/CreateNewPropertyListing.jsp";
	}
	
	function Update()
	{
		window.location.href = "/~5530u47/UpdateProperty.jsp";
	}
...
<center>
	...
	<button class= "ListOrUpdateButton", onclick="CreateNew()">1. Create New Property Listing </button><BR>
	<button class= "ListOrUpdateButton", onclick="Update()">2. Update Housing</button><BR>
